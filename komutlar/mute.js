...
const mutelog = message.guild.channels.cache.find(c => c.id === '848643363804020756')//Mute logu
const muterol = message.guild.roles.cache.find(r => r.id === '848698295671980032')//Muteli rolü
