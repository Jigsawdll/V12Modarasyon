...
const mutelog = message.guild.channels.cache.find(c => c.id === '848643363804020756')//mute log
...
message.channel.send(new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setColor('0x348f36').setTimestamp().setDescription(`${message.author} tarafından ${kullanici} isimli kullanıcının **${sebep}** seslide susturulması bitirildi.`));
message.react('✅')
