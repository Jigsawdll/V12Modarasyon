...
let guild = "839119405329285180"; // - SUNUCU ID
...
var booster = message.guild.roles.cache.get("848668343007576074").members.size
...
.setAuthor(message.guild.name, message.guild.iconURL({ dynamic: true }))
 .setDescription(`
 <:okiareti:848670694337413150> Sunucumuzda Toplam** ${booster} **Booster Üye Bulunmakta.
 <:okiareti:848670694337413150> Sunucumuzda Toplam** ${üyesayısı} **Üye bulunmakta.
 <:okiareti:848670694337413150> Sunucumuzda Toplam** ${cevirimici} **Üye Çevrimiçi.
 <:okiareti:848670694337413150> Tagımızda Toplam** ${taglılar} **Üye Bulunmakta.
 <:okiareti:848670694337413150> Sesli Kanallarda** ${sessayı} **Üye Sohbet Ediyor.`)
